      ...
      <section className="w-3/5 flex flex-row justify-between max-lg:w-11/12">
        ...
        <div
          ...
          className={`flex max-lg:absolute max-lg:w-screen max-lg:top-0 max-lg:left-0 justify-center max-lg:h-screen max-lg:items-start z-40 ${
            menuVisible
              ? "max-lg:backdrop-blur-md max-lg:translate-x-0"
              : "max-lg:-translate-x-x-complete"
          } ease-in-out duration-300 transition`}
        >
          <div
            className={`flex flex-row space-x-10 justify-center items-center max-lg:flex-col max-lg:space-x-0 max-lg:space-y-5 ${
              menuVisible ? "" : ""
            } ease-in-out duration-300 transition max-lg:mt-24 max-lg:w-4/5 max-lg:backdrop-blur-3xl max-lg:p-10 max-lg:rounded-3xl max-lg:ring-2 max-lg:ring-c11 `}
          >
